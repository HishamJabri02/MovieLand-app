    ...
    <>
      <Card
        ...
        <CardMedia
          ...
          image={
            special.color && special.color.images.length !== 0
              ? uploadImage(special.color.images[0])
              : uploadImage(imageCover)
          }>
          {!isActive ||
        ...
        <Typography
          ...
          {isNew ? "New" : "-" + Math.floor(special.discount_ratio) + "%"}
        </Typography>
        <CardContent
          sx={{
            position: "relative",
